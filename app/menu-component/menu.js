function redirect(id) {
    switch(id) {
        case ("funcionarios"):
            window.location.href ="../funcionario-component/lista-funcionario-component/funcionario.html"; 
        break;
        case "departamentos": 
            window.location.href ="../departamento-component/lista-departamento/departamento.html";  
        break;
        case "criar-funcionario": 
            window.location.href = "../funcionario-component/criar-funcionario-component/criar-funcionario.html"; 
        break;
